...
const btnRollDice = document.querySelector('.btn--roll') as HTMLButtonElement;
const btnHold = document.querySelector('.btn--hold') as HTMLButtonElement;
const btnNewGame = document.querySelector('.btn--new') as HTMLButtonElement;
...
const winMessage = document.querySelector('.win') as HTMLSpanElement;
const winnerText = document.querySelector('#player-win') as HTMLSpanElement;
